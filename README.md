# 大数据分析作品集 BigDataAnalysisPortfolio

本仓库收录了用户行为与汽车行业相关的数据分析项目，用于展示数据清洗、SQL 聚合、交互式可视化、用户分群和业务分析能力。

## 在线作品集

[访问 GitHub Pages 作品集首页](https://observl.github.io/BigDataAnalysisPortfolio/)
